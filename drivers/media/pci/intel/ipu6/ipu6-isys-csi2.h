...
#define NR_OF_CSI2_SRC_PADS		4 // HACK IPU4
#define CSI2_PAD_SRC			1
#define NR_OF_CSI2_META_PADS    0
#define NR_OF_CSI2_PADS	(NR_OF_CSI2_SINK_PADS + NR_OF_CSI2_SRC_PADS + NR_OF_CSI2_META_PADS)
