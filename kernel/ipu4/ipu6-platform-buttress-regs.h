...
#define BUTTRESS_FREQ_CTL_ICCMAX_LEVEL		0 // GENMASK(19, 16)
...
#define BUTTRESS_PWR_STATE_HH_STATUS_MASK	GENMASK(13, 12) // NB: 1 bit offset compared to IPU6
...
// IPU4 added BUTTRESS_ISR_SAI_VIOLATION | BUTTRESS_ISR_IPC_FROM_ISH_IS_WAITING | BUTTRESS_ISR_IPC_EXEC_DONE_BY_ISH
// because the 4.19 driver does so. TBD: Not sure if this is required, but it 
// makes the mmiotraces more similar
